...
\end{itemize}
Advanced imaging techniques are crucial for the detailed evaluation of \gls{TV} anatomy and pathology, aiding in the accurate assessment and management of these conditions.~\citeonly{shahTricuspidValveDisease2008}
...
\begin{figure}[H]
    ...
    \caption{Current landscape of TTVR products being used surgically ~\citeonly{curioUpdateCurrentLandscape2019}}
    \label{fig:TTVR}
\end{figure}
\newthought{Impact of Valve Modeling and Simulation:}\\
...
\newthought{Fidelity to Human Anatomy and Physiology in Computational and Physical Simulators:}\\
\begin{itemize}
...
\newthought{Emerging Materials and Technologies:}\sidenote{essentially adding nano-sized building blocks into the polymer matrix which enhances durability while maintaining flexibility and processability}\\
